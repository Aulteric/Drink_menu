            ...
            get
            {
                return new List<Drink>
                {
                    new Drink {
                        ...
                        ImageUrl = "https://lrbbrewers.com/wp-content/uploads/2018/09/CT-Beer-Scene.jpg",
                        InStock = true,
                        IsPreferredDrink = true,
                        ImageThumbnailUrl = "https://lrbbrewers.com/wp-content/uploads/2018/09/CT-Beer-Scene.jpg"
                    },
                    new Drink {
                        Name = "Rum & Coke",
                        ...
                        Category =  _categoryRepository.Categories.First(),
                        ImageUrl = "https://search.chow.com/thumbnail/800/600/www.chowstatic.com/assets/2015/02/10223_cuba_libre_3000.jpg",
                        InStock = true,
                        IsPreferredDrink = false,
                        ImageThumbnailUrl = "https://search.chow.com/thumbnail/800/600/www.chowstatic.com/assets/2015/02/10223_cuba_libre_3000.jpg"
                    },
                    new Drink {
                        Name = "Tequila ",
                        ...
                        Category =  _categoryRepository.Categories.First(),
                        ImageUrl = "https://cdn.dribbble.com/users/571914/screenshots/5731077/toro_enchilado-logov1-800px.png",
                        InStock = true,
                        IsPreferredDrink = false,
                        ImageThumbnailUrl = "https://cdn.dribbble.com/users/571914/screenshots/5731077/toro_enchilado-logov1-800px.png"
                    },
                    new Drink
                    {
                        Name = "Juice ",
                        ...
                        ImageUrl = "https://timesofindia.indiatimes.com/thumb/msid-69409726,imgsize-1547795,width-800,height-600,resizemode-4/69409726.jpg",
                        InStock = true,
                        IsPreferredDrink = false,
                        ImageThumbnailUrl = "https://timesofindia.indiatimes.com/thumb/msid-69409726,imgsize-1547795,width-800,height-600,resizemode-4/69409726.jpg"
                    }
                };
            }
        }
